...
class Client:
    ...
    def post(self, endpoint: str,params: Optional[Dict[str, Any]] = None, json: Optional[Dict[str, Any]] = None, data=None, headers=None):
        return self._request("POST", endpoint, params=params, json=json, data=data, headers=headers)

    def put(self, endpoint: str,params: Optional[Dict[str, Any]] = None, json: Optional[Dict[str, Any]] = None, headers=None):
